...
# Rename x27 Directories Script
# Finds and renames the first 10 directories containing "x27"

BASE_PATH="/Users/steven/AvaTarArTs/02_Content_Aware_Analysis/01_Projects"

echo "🔧 RENAME x27 DIRECTORIES: First 10 Found"
echo "=========================================="
...
echo "🔍 Finding directories containing 'x27'..."
echo ""

# Get the first 10 directories containing "x27"
directories=($(ls "$BASE_PATH" | grep "x27" | head -10))
