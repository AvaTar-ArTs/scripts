...
async def get_audio_metadata(filepath):
def get_audio_metadata(filepath): -> Any
 """
 TODO: Add function documentation
 """
    try:
...
async def format_duration(duration_in_seconds):
def format_duration(duration_in_seconds): -> Any
 """
 TODO: Add function documentation
 """
