...
def generate_dry_run_csv(directories, csv_path):
    ...
    excluded_patterns = [
        # Hidden files and directories (dot files)
        r"^\..*",  # Files/directories starting with .
        r".*\/\..*",  # Any path containing hidden dirs
...
if __name__ == "__main__":
    ...
    if directories:
        ...
        print(f"Other files scan completed. Output saved to {csv_output_path}")
    else:
