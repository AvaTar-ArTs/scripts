    ...
    while True:
        if last_directory:
            ...
            if use_last == 'y':
                ...
                source_directory = input("Please enter a new source directory to scan for video files: ").strip()
        else:
            source_directory = input("Please enter a source directory to scan for video files: ").strip()
