...
# Rename First 10 Directories Script
# Simply renames the first 10 directories found

BASE_PATH="/Users/steven/AvaTarArTs/02_Content_Aware_Analysis/01_Projects"

echo "🎯 RENAME FIRST 10 DIRECTORIES"
echo "==============================="
...
echo "🔍 Getting first 10 directories..."
echo ""

# Get the first 10 directories
directories=($(ls "$BASE_PATH" | head -10))
